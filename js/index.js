...
//               // Отримуємо доступ до елементів. Масив елементів.
// const spollers = document.querySelectorAll('.spoller__body');

// // Отримуємо доступ до всіх елементів за допомогою цикла for.
// for (let item = 0; item < spollers.length; item++) {

//     const element = spollers[item];

//     element.addEventListener('click', function (e) {

//         // Отримуємо доступ до cусіднього елемента
//         const elementOpen = element.nextElementSibling;
